(function(window, document, undefined) {
    ...
    (function($) {
        ...
        {//lakshitha
            ...
            var input = '<input id="newLabel" results="5" type="search" class="' + classes.sFilterInput + '"/>';
        ...
        function _fnFeatureHtmlLength(settings)
        {
            ...
            var select = $('<select/>', {
                ...
                'id': 'comboId'//lakshitha set combo box id
            });
...
//lakshitha
        ...
        DataTable.defaults = {
            ...
            "aaSortingFixed": [],
            "ajax": null,
            "aLengthMenu": [], //lakshitha set combo value
            "aoColumns": null,
            "aoColumnDefs": null,
            "aoSearchCols": [],
            ...
            "iStateDuration": 7200,
            "iDeferLoading": null,
            "iDisplayLength": 'Select Count', //lakshitha set default table data countS
            "iDisplayStart": 0,
            "iTabIndex": 0,
            "oClasses": {},
            "oLanguage": {
                ...
                "sInfo": '<img src="https://cdn1.iconfinder.com/data/icons/Copenhagen/PNG/48/pdf.png" title="Print" style="cursor:pointer;width:30px;height:30px" onclick="setPrint(' + "'dataTableId'" + ')"/>&nbsp;&nbsp;<img  src="https://cdn1.iconfinder.com/data/icons/Momentum_MatteEntireSet/32/excel.png" title="Excel" style="cursor:pointer;width:30px;height:30px" onclick="setExcell(' + "'dataTableId'" + ')"/>', //lakshitha set print and excell button
                "sInfoEmpty": "",
                "sInfoFiltered": "",
                "sInfoPostFix": "",
                "sDecimal": "",
                "sThousands": ",",
                "sLengthMenu": "Number of Rows _MENU_ ", //show combobox lakshitha
                "sLoadingRecords": "Loading...",
                "sProcessing": "",
                "sSearch": "Type a word to Search:",
                "sUrl": "",
        ...
        DataTable.defaults.column = {"aDataSort": null,
            "iDataSort": -1,
            "asSorting": ['asc', 'desc'],
            "bSearchable": true,
            "bSortable": true,
        ...
        DataTable.models.oSettings = {"oFeatures": {"bAutoWidth": null,
                "bDeferRender": null,
                "bFilter": null,
                "bInfo": null,
                "bLengthChange": null,
        ...
        $.extend(_ext, {afnFiltering: _ext.search,
        ...
        $.extend(DataTable.ext.classes, {"sTable": "dataTable",
            "sNoFooter": "no-footer",
            ...
            "sJUIHeader": "",
            "sJUIFooter": "",
            "sPrint": "dataTables_print", //lakshitha set new style for print button
            "sExcel": "dataTables_excel"
        });
        ...
        (function() {
            ...
            $.extend(DataTable.ext.oJUIClasses, DataTable.ext.classes, {"sPageButton": "fg-button ui-button " + _stateDefault,
        ...
        $.extend(true, DataTable.ext.renderer, {pageButton: {_: function(settings, host, idx, buttons, page, pages) {
                    ...
                    var attach = function(container, buttons) {
                        ...
                        for (i = 0, ien = buttons.length; i < ien; i++) {
                            ...
                            if ($.isArray(button)) {
                                ...
                                if (btnDisplay) {
                                    node = $('<a>', {'class': classes.sPageButton + ' ' + btnClass,
                    ...
                    attach($(host).empty(), buttons);//lakshitha set pagination
                }
            }
        });
